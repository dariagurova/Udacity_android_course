...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray jsonArray = sampleResponse.getJSONArray("features");

            for(int i = 0; i < jsonArray.length(); i++){
                JSONObject currEarthQ = jsonArray.getJSONObject(i);
                JSONObject properties = currEarthQ.getJSONObject("properties");
